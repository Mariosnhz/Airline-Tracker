...
int main(int argc, char* argv[]) {
  //variable needed in main to complete infinite loop
    int input;
    char origin[4];
    char dest[4];
    char airline[3];
    ...
    for(;;) {
      printMenu();
      //used fgets instead of scanning a charecter. Possibility of inserting number 10, scanning a charecter would only store the first charecter
      fgets(buff,3,stdin);
